...
function update_netlify () {
  ...
  if [ -f ./netlify.toml ]; then
    echo "Attempting to get compatible Hugo version from https://raw.githubusercontent.com/wowchemy/wowchemy-hugo-themes/main/modules/wowchemy/config.yaml ..."
    curl -o "tmp_get_version" https://raw.githubusercontent.com/wowchemy/wowchemy-hugo-themes/main/modules/wowchemy/config.yaml
